  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <Building className="text-teal-500 h-8 w-8" />
              <span className="ml-2 text-xl font-semibold text-navy-500">McCone Properties</span>
            </div>

            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-800 hover:text-teal-500 font-medium">Buy</a>
              <a href="#" className="text-gray-800 hover:text-teal-500 font-medium">Rent</a>
              <div className="relative group">
                <a href="#" className="text-gray-800 hover:text-teal-500 font-medium flex items-center">
                ...
                <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden z-20 transform scale-0 group-hover:scale-100 transition-transform origin-top">
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">About Us</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Meet the Team</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Awards and Recognition</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Latest News & Insights</a>
                </div>
              </div>
              <div className="relative group">
                <a href="#" className="text-gray-800 hover:text-teal-500 font-medium flex items-center">
                ...
                <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden z-20 transform scale-0 group-hover:scale-100 transition-transform origin-top">
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Property Sales</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Property Rentals</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Property Management</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Mortgage Assistance</a>
                  <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-teal-500 hover:text-white">Conveyancing Services</a>
                </div>
              </div>
              <a href="#" className="text-gray-800 hover:text-teal-500 font-medium">Careers</a>
              <a href="#" className="text-gray-800 hover:text-teal-500 font-medium">Contact</a>
            </nav>

            {/* Right side buttons */}
            <div className="hidden md:flex items-center space-x-4">
              <a href="#" className="text-gray-800 hover:text-teal-500 flex items-center">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-lg">
            <div className="px-4 py-2 space-y-1">
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">Buy</a>
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">Rent</a>
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">About</a>
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">Services</a>
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">Careers</a>
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">Contact</a>
              <a href="#" className="block py-2 text-gray-800 hover:text-teal-500">Sign Up/Login</a>
              <a href="#" className="block py-2 mt-4 bg-teal-500 text-white px-4 rounded-md">List Your Property</a>
            </div>
          </div>
        )}
      </header>
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center text-white px-4">
          ...
          <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="flex border-b">
              <button 
                className={`flex-1 py-3 font-medium ${activeTab === 'buy' ? 'text-teal-500 border-b-2 border-teal-500' : 'text-gray-600'}`}
                onClick={() => setActiveTab('buy')}
              >
                Buy
              </button>
              <button 
                className={`flex-1 py-3 font-medium ${activeTab === 'rent' ? 'text-teal-500 border-b-2 border-teal-500' : 'text-gray-600'}`}
                onClick={() => setActiveTab('rent')}
              >
                Rent
              </button>
              <button 
                className={`flex-1 py-3 font-medium ${activeTab === 'off-plan' ? 'text-teal-500 border-b-2 border-teal-500' : 'text-gray-600'}`}
            ...
            <div className="flex flex-col md:flex-row p-4">
              <div className="flex-1 mb-3 md:mb-0 md:mr-2">
                <div className="relative">
                  ...
                  <select className="w-full pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500">
            ...
            {properties.map(property => (
              <div key={property.id} className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:-translate-y-2">
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4 bg-teal-500 text-white px-3 py-1 rounded-md text-sm font-medium">
                    {property.status}
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-teal-500 text-2xl font-bold mb-2">{property.price}</h3>
                  <h4 className="text-gray-800 text-xl font-semibold mb-2">{property.title}</h4>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button className="flex-1 bg-teal-500 hover:bg-teal-600 text-white py-2 rounded-md flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <a href="#" className="text-teal-500 hover:text-teal-600 font-medium flex items-center">
      ...
      <section className="py-16 bg-teal-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <a href="#" className="bg-white text-teal-500 hover:bg-gray-100 px-8 py-3 rounded-md font-medium transition-colors">
              List Your Property
            </a>
            <a href="#" className="bg-white text-teal-500 hover:bg-gray-100 px-8 py-3 rounded-md font-medium transition-colors">
              Get in Touch
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Buy Property</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Rent Property</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">List Your Property</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Mortgage Calculator</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Downtown Dubai</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Dubai Marina</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Dubai Hills Estate</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Palm Jumeirah</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">Business Bay</a></li>
                <li><a href="#" className="text-gray-400 hover:text-teal-500 transition-colors">JVC</a></li>
              </ul>
            </div>
      ...
      {showBackToTop && (
        <button 
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 bg-teal-500 text-white p-3 rounded-full shadow-lg hover:bg-teal-600 transition-colors"
        >
